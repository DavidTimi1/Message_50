...
function UploadOptions({ open, selectFile }) {
    ...
    return (
        ...
        <div className="abs br-1 flex opts close gap-2" ref={mainRef}>
            <Option label="Image">
                <input className='hide' type="file" accept="image/*" onInput={handleInput} />
                <i className="fa-solid fa-image abs-mid"></i>
            </Option>
            <Option label="Audio">
                <input className='hide' type="file" accept="audio/*" onInput={handleInput} />
                <i className="fa-solid fa-file-audio abs-mid"></i>
            </Option>
            <Option label="Video">
                <input className='hide' type="file" accept="video/*" onInput={handleInput} />
                <i className="fa-solid fa-film abs-mid"></i>
            </Option>
            <Option label="Other">
                <input className='hide' type="file" onInput={handleInput} />
                <i className="fa-solid fa-file abs-mid"></i>
            </Option>
        </div>
    )
    ...
    function Option({ children, label }) {
        return (
                        ...
                        saved ?
                            <>
                                ...
                                <div className="dropdown">
                                    <i className="fa-solid fa-ellipsis-vertical" role="button" data-bs-toggle="dropdown" aria-expanded="false"></i>
                            ...
                            saved ?
                                ...
                                <>
                                    <button className="no-btn p-but">
                                        {
                                            loadProgress === false ?
                                                <i className="fa-solid fa-circle-arrow-down down-icon fa-xl" aria-label="Click to download audio"></i>
                                                :
                                                <span className="hide block">
                                                    ...
                                                    <i className="fa-solid fa-xmark abs-mid ds fa-xl" role="button"></i>
                                                </span>
                                        }
                                    </button>
                                </>
                ...
                <div className="vid-cont max-child">
                    {
                        saved ?
                            <>
                                <video src=""></video>
                                <i className="fa-solid fa-circle-play fa-2xl abs-mid"></i>
                                <div className="dropdown">
                                    <i className="fa-solid fa-ellipsis-vertical" role="button" data-bs-toggle="dropdown" aria-expanded="false"></i>
                                    <ul className="dropdown-menu">
                                        <li><button className="dropdown-item">Save to device</button></li>
                        ...
                        saved ?
                            ...
                            <>
                                <div className="file-icon">
                                    {
                                        loadProgress === false ?
                                            <i className="fa-solid fa-arrow-down fa-lg down-icon" aria-label="Click to download file" role="button"></i>
                                            :
                                            <div>
                                                <svg height="50px" width="50px" style={{ backgroundColor: "grey", clipPath: "circle()", rotate: "-90deg" }}>
                                                    <circle cx="25px" cy="25px" r="20px" fill="none" stroke="green" stroke-width="7px" stroke-linecap="round"></circle>
                                                </svg>
                                                <i className="fa-solid fa-xmark abs-mid ds fa-lg" role="button"></i>
                                            </div>
                                    }
                                </div>
        ...
        <div className="abs-mid">
            {
                loadProgress !== false ?
                    ...
                    :
                    <i className="fa-solid fa-arrow-down img-size down-icon" role="button"></i>
            }
        </div>
    </div>
}
